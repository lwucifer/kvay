            ...
            <uni-list>
                <view data-url="realname/realname" data-type="realname" @tap="onGoTo">
                    <uni-list-item :title="$t('user.shiMingXingXi')" show-extra-icon="true" :extra-icon="{type: 'contact'}"
                                   :sub="$t('user.sub1')" :required="true" :note="realname.descript" showArrow="true" showText="true" :text="realname.status"></uni-list-item>
                </view>
                <view data-url="member/member" data-type="member" @tap="onGoTo">
                    <uni-list-item :title="$t('user.geRenXingXi')" show-extra-icon="true" :extra-icon="{type: 'list'}"
                                   :sub="$t('user.sub2')" :required="true" :note="member.descript" showArrow="true" showText="true" :text="member.status"></uni-list-item>
                </view>
                <view data-url="work/work" data-type="work" @tap="onGoTo">
                    <uni-list-item :title="$t('user.gongZuoXingXi')" show-extra-icon="true" :extra-icon="{type: 'email-filled'}"
                                   :sub="$t('user.sub3')" :required="true" :note="work.descript" showArrow="true" showText="true" :text="work.status"></uni-list-item>
                </view>
                <view data-url="bank/edit" data-type="bank" @tap="onGoTo">
                    <uni-list-item :title="$t('user.yingHangXinXi')" show-extra-icon="true" :extra-icon="{type: 'scan'}"
                                   :sub="$t('user.sub4')" :required="true" :note="bank.descript" showArrow="true" showText="true" :text="bank.status"></uni-list-item>
                </view>
                <view :data-url="mobileUrl" data-type="mobile" @tap="onGoTo">
                    <uni-list-item :title="$t('user.yunYingShangXingXi')" show-extra-icon="true" :extra-icon="{type: 'phone-filled'}"
                                   :sub="$t('user.sub6')" :required="true" :note="mobile.descript" showArrow="true" showText="true" :text="mobile.status"></uni-list-item>
                </view>
<!--                <view data-url="fackbook/fackbook" data-type="fackbook" @tap="onGoTo">-->
<!--                    <uni-list-item :title="$t('user.fackbookXingXi')" show-extra-icon="true" :extra-icon="{type: 'more-filled'}"-->
<!--                                   :sub="$t('user.sub6')" :note="fackbook.descript" showArrow="true" showText="true" :text="fackbook.status"></uni-list-item>-->
<!--                </view>-->
            </uni-list>
        </view>
